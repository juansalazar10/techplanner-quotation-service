...
public class QuotationServiceImpl implements QuotationService {
    ...
    public QuotationServiceImpl(RecommendationProcessService recommendationProcessService, CompatibilityService compatibilityService) {
    ...
    public QuotationResponse createQuotation(QuotationRequest request) {
        List<ComponentDto> componentsToAnalyze = request.components() == null || request.components().isEmpty()
            ? recommendationProcessService.recommend(request.usageType(), request.budget())
            : request.components();
